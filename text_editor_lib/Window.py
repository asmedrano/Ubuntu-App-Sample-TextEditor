...
import logging
logger = logging.getLogger('text_editor_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by TextEditorWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseTextEditorWindow object.
        """
        builder = get_builder('TextEditorWindow')
        new_object = builder.get_object("text_editor_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a TextEditorWindow object with it in order to finish
        initializing the start of the new TextEditorWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.text-editor")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('text-editor')
        except ImportError:
            pass
        ...
        try:
            from text_editor import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for text-editor."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for text-editor."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the TextEditorWindow."""
        self.destroy()
